...
<style scoped lang="postcss">
  nav {
    @apply flex h-20 bg-cyan-900 text-slate-200;
    .wrapper {
      @apply container mx-auto flex w-full items-center justify-between;
      .brand {
        &-title {
          @apply text-2xl font-bold text-orange-100;
        }
      }
      .menu {
        @apply flex gap-2;
        ...
        &-item {
          @apply rounded-md px-4 py-2 hover:bg-orange-100 hover:text-slate-900;
        }
        &-login {
          @apply rounded-md bg-orange-200 px-4 py-2 text-slate-900 hover:bg-orange-700;
        }
        &-logout {
